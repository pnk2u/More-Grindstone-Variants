...
public class MgvItemInit {
    ...
    public static final BlockItem PALE_OAK_GRINDSTONE_I = itemFromBlock(PALE_OAK_GRINDSTONE);
    ...
    public static final BlockItem PALE_OAK_SANDSTONE_GRINDSTONE_I = itemFromBlock(PALE_OAK_SANDSTONE_GRINDSTONE);
    ...
    public static final BlockItem PALE_OAK_DEEPSLATE_GRINDSTONE_I = itemFromBlock(PALE_OAK_DEEPSLATE_GRINDSTONE);
    ...
    public static final BlockItem PALE_OAK_BASALT_GRINDSTONE_I = itemFromBlock(PALE_OAK_BASALT_GRINDSTONE);
    ...
    public static final BlockItem PALE_OAK_GRANITE_GRINDSTONE_I = itemFromBlock(PALE_OAK_GRANITE_GRINDSTONE);
    ...
    public static void registerItems() {
        ...
        registerItem(PALE_OAK_GRINDSTONE_I, OAK_GRINDSTONE_I);
        registerItem(SPRUCE_GRINDSTONE_I, PALE_OAK_GRINDSTONE_I);
        ...
        registerItem(PALE_OAK_SANDSTONE_GRINDSTONE_I, OAK_SANDSTONE_GRINDSTONE_I);
        registerItem(DARK_OAK_SANDSTONE_GRINDSTONE_I, PALE_OAK_SANDSTONE_GRINDSTONE_I);
        ...
        registerItem(PALE_OAK_DEEPSLATE_GRINDSTONE_I, OAK_DEEPSLATE_GRINDSTONE_I);
        registerItem(DARK_OAK_DEEPSLATE_GRINDSTONE_I, PALE_OAK_DEEPSLATE_GRINDSTONE_I);
        ...
        registerItem(PALE_OAK_BASALT_GRINDSTONE_I, OAK_BASALT_GRINDSTONE_I);
        registerItem(DARK_OAK_BASALT_GRINDSTONE_I, PALE_OAK_BASALT_GRINDSTONE_I);
        ...
        registerItem(PALE_OAK_GRANITE_GRINDSTONE_I, OAK_GRANITE_GRINDSTONE_I);
        registerItem(DARK_OAK_GRANITE_GRINDSTONE_I, PALE_OAK_GRANITE_GRINDSTONE_I);
